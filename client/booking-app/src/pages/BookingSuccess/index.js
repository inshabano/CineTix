...
function BookingSuccessPage() {
  ...
  const showDate = bookingDetails.show?.showDate
    ? new Date(bookingDetails.show.showDate).toLocaleDateString("en-GB", {
        day: "2-digit",
        month: "2-digit",
        year: "numeric",
      })
      ...
      <div className="booking-success-container">
        ...
        >
          <p className="welcome-message">
            Hello, <span className="highlight-username">{username}</span>!
          </p>
          ...
          <Row gutter={[16, 16]} className="details-row">
            <Col xs={24} md={12}>
              <p>
                ...
                <span className="highlight">{bookingDetails._id}</span>
              </p>
              <p>
              ...
              <p>
                <strong>Movie:</strong>{" "}
                {bookingDetails.show?.movie?.movieName || "N/A"} (
                {bookingDetails.show?.movie?.language || "N/A"})
              </p>
              <p>
                <strong>Theatre:</strong>{" "}
                {bookingDetails.show?.theatre?.name || "N/A"}
              </p>
            </Col>
            <Col xs={24} md={12}>
              <p>
                <strong>Address:</strong>{" "}
                {bookingDetails.show?.theatre?.address || "N/A"}
              </p>
              <p>
              ...
              <p>
                ...
                {(bookingDetails.totalAmount || 0).toFixed(2)}
              </p>
            </Col>
          </Row>
