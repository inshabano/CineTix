  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        console.log(
          `Current Time (now): ${now.format("YYYY-MM-DD HH:mm:ss Z")}`
        );
        ...
        fetchedBookings.forEach((booking) => {
          ...
          console.log(
            `  Constructed ShowDateTime: ${showDateTime.format(
  ...
  const renderBookingCard = (booking) => (
    <div key={booking._id} className="booking-card">
      ...
      <div className="booking-card-body">
        ...
        <p>
          <strong>Time:</strong> {booking.show.showTime}
        </p>
        <p>
          <strong>Theatre:</strong> {booking.show.theatre.name}
        </p>
        <p>
          <strong>Location:</strong> {booking.show.theatre.address}
        </p>
        <p>
          <strong>Seats:</strong>{" "}
      ...
      <div className="bookings-container">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            View your upcoming and past movie shows.
          </p>
        </div>
